      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-6 col-xl-3">
            <div className="single-service">
              <div className="service-icon">
                <Image width={92} height={92} src="/images/i1.png.webp" alt="Test preparation icon" />
              </div>
              <div className="service-content">
                <h5>TEST PREP</h5>
                <p>
                  Experience personalized attention that helps you excel, ensuring a deeper
          ...
          <div className="col-md-6 col-xl-3">
            <div className="single-service">
              <div className="service-icon">
                <Image width={83} height={83} src="/images/i2.png.webp" alt="Group lessons icon" />
              </div>
              <div className="service-content">
                <h5>GROUP LESSONS</h5>
                <p>
          ...
          <div className="col-md-6 col-xl-3">
            <div className="single-service">
              <div className="service-icon">
                <Image width={53} height={92} src="/images/i3.png.webp" alt="One-on-one coaching icon" />
              </div>
              <div className="service-content">
          ...
          <div className="col-md-6 col-xl-3">
            <div className="single-service">
              <div className="service-icon">
                <Image width={82} height={82} src="/images/i4.png.webp" alt="Skill development icon" />
              </div>
              <div className="service-content">
